                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-5">
                                    ...
                                    <select name="task_id[]" class="form-control {{ $errors->has('task_id') ? 'is-invalid' : '' }}" id="" required>
                                        ...
                                        <option value="{{$task->id}}" {{($edit->task_id==$task->id?"selected":"")}}>{{$task->name}} </option>
                                        @endforeach
                                    </select>
                                    @error('task_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <input name="amount[]" value="{{$edit->amount}}" class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="number" id="amount" required>
                                    @error('amount')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
