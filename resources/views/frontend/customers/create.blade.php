    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header ">
                ...
                <h3 class="card-title">
                    <a href="{{route('customers.index')}}" class="float-right btn btn-success btn-sm"><i class="fa fa-list"></i> Listes des Clients</a>
                </h3>
            ...
            <div class="card-body">
                ...
                <h4 class="card-title ">Créer Client </h4><br>


                <form id="myForm" method="post" action="{{ route('customers.store') }}">
                    @csrf
                    ...
                    <button type="submit" class="btn  btn-outline-primary waves-effect waves-light">Enregister</button>
                </form>
