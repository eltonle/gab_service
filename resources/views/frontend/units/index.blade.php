    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header ">
                ...
                <h3 class="card-title">Listes des Unités
                    <a href="{{route('units.create')}}" class="float-right btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> Ajouter une Unité</a>
                </h3>
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$item->name}}</td>
                            <td>
                                <a href="{{route('units.edit', $item->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                <!-- <a href="" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a> -->
                                @php
                                $count_unit = App\Models\Product::where('unit_id', $item->id)->count();
                                @endphp
                                @if($count_unit < 1) <button type="button" class="btn  btn-outline-danger waves-effect waves-light btn-sm delete-btn " data-supplier-id="{{ $item->id }}">
            ...
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = "/units/delete/" + supplierId;
                    }
                });
            });
        });
