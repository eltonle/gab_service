                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($item->status=="0")
                                    <a href="{{route('service.approve', $item->id)}}" class="btn btn-sm btn-outline-info waves-light"><i class="fas fa-check-circle"></i></a>
            ...
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = "/service/delete/" + supplierId;
                    }
                });
            });
        });
